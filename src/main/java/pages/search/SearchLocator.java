...
public class SearchLocator {
    ...
    public static final By NOTHING_FOUND_MESSAGE = By.xpath("//h2[normalize-space(.)='Ничего не найдено.']");
    public static final By PRODUCT_IMAGE = By.xpath("//img[contains(@class,'product-img')]");
}
